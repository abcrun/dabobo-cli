...
module.exports = (mode, env) => {
  ...
  const { publicPath, filename, chunkFileName } = miniCssExtract;
  ...
  plugins.push(
    new MiniCssExtractPlugin({
      filename: mode === 'development' ? '[name].css' : filename,
      chunkFilename: mode === 'development' ? '[name].css' : chunkFileName,
    })
  );
