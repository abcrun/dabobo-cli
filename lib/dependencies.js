...
const getPkg = (name) => {
  console.log();
  console.log(chalk.greenBright('waiting to install ...'));
...
module.exports = (answers) => {
  ...
  const comp = ['@babel/runtime', 'core-js'];
  ...
  if (frame === 1) {
    ...
    if (lint !== 2)
      lints.push('eslint-plugin-react', 'eslint-plugin-react-hooks');
  ...
  return {
    dependencies: comp,
    devDependencies: [...lints, ...babels, ...types, ...webpack, ...build],
  };
};
